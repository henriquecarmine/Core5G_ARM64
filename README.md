...
| ✅ Resolvido | **Estudos por cadeira (Fase C)**: rail do console com um dropdown por disciplina, aulas detalhadas extraídas dos slides (`/lab/estudo/{n}/aula/{k}`: conceitos, fórmulas, "onde roda" no mini-mapa, exercícios, quiz) e **os 7 temas do projeto integrador** da disciplina de dados como comandos com fonte de dados trocável (amostra do professor · arquivo · colado). Doc: [`docs/estudos-por-cadeira.md`](docs/estudos-por-cadeira.md) | ✅ v0.64.0 |
