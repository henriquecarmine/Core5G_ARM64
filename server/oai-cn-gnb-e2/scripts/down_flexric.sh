...
pkill -9 -f "xapp_cust_moni" 2>/dev/null || true
pkill -9 -f "xapp_all_moni" 2>/dev/null || true
pkill -9 -f "xapp_kpm_moni" 2>/dev/null || true
pkill -9 -f "xapp_rc_moni" 2>/dev/null || true
pkill -9 -f "xapp_gtp_mac_rlc_pdcp_moni" 2>/dev/null || true
pkill -9 -f "xapp_kpm_rc" 2>/dev/null || true
