...
# Dados do subscriber (default = ue.yaml). Sobrescrevíveis via env var
# (usado pelo painel web em server/panel/, sem mudar o uso direto do script).
IMSI="${SUB_IMSI:-001010000000002}"
MSISDN="${SUB_MSISDN:-33638060000}"
K="${SUB_K:-465B5CE8B199B49FAA5F0A2EE238A6B0}"
OPC="${SUB_OPC:-E8ED289DEBA952E4283B54E88E6183B8}"
OP="${SUB_OP:-$OPC}"
AMF="${SUB_AMF:-8000}"
